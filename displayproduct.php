...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link text-white  fs-5" href="Admain.php">Users</a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white  fs-5" href="Admain.php">Masseages</a>
              </li>
            </ul>
  ...
  <!--end navbar-->
   ...
   <!--start product-->
   <h2 class="text-center mt-4 mb-4" id="mssages">Products<h2>
    ...
    if($result){
        while($row=mysqli_fetch_assoc($result)){
            ...
            echo'<tr>
                    ...
                    <td>'.$info.'</td>
                    <td>$'.$price.'</td>
                    <td ><img  height="100px" width="150px" src="uplodimge/'.$img.' "></td>
